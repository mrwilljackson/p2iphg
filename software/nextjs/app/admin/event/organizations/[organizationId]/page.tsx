            ...
            <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6 mb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                <div className="text-center p-4 bg-gray-50 rounded-lg">
                  <p className="text-sm font-medium text-gray-600 mb-2">Expected Participants</p>
                  <p className="text-3xl font-bold text-gray-900">{expectedCount}</p>
                </div>
                <div className="text-center p-4 bg-gray-50 rounded-lg">
                  <p className="text-sm font-medium text-gray-600 mb-2">Registered Participants</p>
                ...
                <div className={`text-center p-4 rounded-lg ${expectedCount > registeredCount ? 'bg-yellow-50' : 'bg-green-50'}`}>
                  <p className="text-sm font-medium text-gray-600 mb-2">Missing Registrations</p>
                  <p className={`text-3xl font-bold ${expectedCount > registeredCount ? 'text-yellow-600' : 'text-green-600'}`}>

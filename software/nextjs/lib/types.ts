...
export interface Registration {
  ...
  organizationId: string; // Airtable organization record ID (REQUIRED)
  impairment: string; // Accessibility needs (REQUIRED, free text)
  role: RegistrationRole; // "Attendee" | "Volunteer" (REQUIRED)
